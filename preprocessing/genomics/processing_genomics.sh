...
WDIR=/mnt/nas/global/ame-ige/DSPN_analysis/genotype
DDIR=/mnt/nas/global/ame-ige/omicsdata/genotypes/KORAS4F4_affyaxiom_n3788/imputed/HRC/HRCPanel_r1.1/chr1_22/vcf
...
dirlist=(scratch qc popstrat gwas)
for dir in  ${dirlist[@]} 
do
	if [[ -d ${WDIR}/${dir} ]] 
	then
